...
class CustomColumn extends Column
    /**
     * CustomColumn is a column for the [[GridView]] widget that displays buttons for viewing and manipulating the items.
     *
     * To add an CustomColumn to the gridview, add it to the [[GridView::columns|columns]] configuration as follows:
     *
     * ```php
     * 'columns' => [
     *     // ...
     *     [
     *         'class' => CustomColumn::className(),
     *         // you may configure additional properties here
     *     ],
     * ]
     * ```
     *
     * For more details and usage information on CustomColumn, see the [guide article on data widgets](guide:output-data-widgets).
     *
     ...
     */
{
     ...
     * {@inheritdoc}
     */
    public $headerOptions = ['class' => 'custom-column'];
    /**
     ...
     *
     * As an example, to only have the view, and update button you can add the CustomColumn to your GridView columns as follows:
     *
     * ```php
     * ['class' => 'app\widgets\CustomColumn', 'template' => '{view} {update}'],
     * ```
     *
     * @see buttons
     */
     ...
     *
     * ```php
     * function (string $action, mixed $model, mixed $key, integer $index, CustomColumn $this) {
     *     //return string;
     * }
     * ```
     *
