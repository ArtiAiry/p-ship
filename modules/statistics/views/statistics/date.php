...
<badge id="datesreportrange" class="btn btn-outline-primary">
...
<div class="card fade-out">
    <div class="card-body">
        <h3 class="mb-2 ml-3">
            ...
            <table id="dates-table" class="table table-hover table-bordered dt-responsive nowrap" style="width:100%">
                <thead>
                <tr>
                ...
                <?php foreach($leads as $lead):?>
                    <tr>
                        <td><?= Yii::$app->formatter->asDate($lead->date) ?></td>
