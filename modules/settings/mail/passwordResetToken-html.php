...
<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; width: 100%;" class="background"><tr><td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;"
	...
	max-width: 500px;" class="wrapper">
			...
			padding-top: 0px;" class="hero"><a target="_blank" style="text-decoration: none;"
                                               href="http://bontip.ru/"><img border="0" vspace="0" hspace="0"
                                                                             src="<?= $reset; ?>"
                                                                             alt="Смена пароля" title="Смена пароля"
                                                                             width="340" style="
			width: 87.5%;
			max-width: 340px;
			...
			font-family: sans-serif;" class="paragraph">
                        Для того, чтобы создать новый пароль, нажмите на кнопку перехода на страницу смены пароля ниже:
                    </td>
                </tr>
...
<?= $resetLink ?>">
			...
			color: #FFFFFF;
			font-family: sans-serif;" class="supheader">
                        Если запрос на смену пароля делали не Вы - проигнорируйте это сообщение, либо же обратитесь к нам.
                    </td>
                </tr>
