                    ...
                    <?php foreach($statuses as $status):?>
                        <tr>
                            ...
                            <td>
                                ...
                                <button value="<?= Url::toRoute(['/payout/status/view','id'=>$status->id]);?>" data-toggle="tooltip" title="<?= Module::t('status','View') ?>" aria-label="View" class="btn btn-outline-dark btn-rounded btn-xs view-modal-click"><span class="fa fa-eye"></span></button>
                                <a href="<?= Url::toRoute(['/payout/status/update','id'=>$status->id]);?>" data-toggle="tooltip"  title="<?= Module::t('status','Update') ?>" aria-label="Update" class="btn btn-outline-dark btn-rounded btn-xs update-modal-click"><span class="fa fa-pencil" ></span></a>
                                <button value="<?= Url::toRoute(['/payout/status/remove','id'=>$status->id]);?>" data-toggle="tooltip"  title="Delete" aria-label="<?= Module::t('status','Delete') ?>" data-confirm="Are you sure you want to delete this item?" class="btn btn-outline-dark btn-rounded btn-xs" data-method="post"><span class="fa fa-trash"></span></button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
