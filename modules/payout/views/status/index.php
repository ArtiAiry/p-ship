                    ...
                    <?php foreach($statuses as $status):?>
                        <tr>
                            ...
                            <td>
                                ...
                                <button value="<?= Url::toRoute(['/payout/status/delete','id'=>$status->id]);?>" data-toggle="tooltip"  title="Delete" aria-label="<?= Module::t('status','Delete') ?>" data-confirm="Are you sure you want to delete this item?" class="btn btn-outline-dark btn-rounded btn-xs" data-method="post"><span class="fa fa-trash"></span></button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
