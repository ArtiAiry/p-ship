                    ...
                    <?php foreach($statuses as $status):?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= Url::toRoute(['/leads/status/remove','id'=>$status->id]);?>" data-toggle="tooltip"  title="<?= Module::t('status','Delete') ?>" aria-label="Delete" data-confirm="<?= Module::t('status','Are you sure you want to delete this item?') ?>" class="btn btn-outline-dark btn-rounded btn-xs" data-method="post"><span class="fa fa-trash"></span></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
