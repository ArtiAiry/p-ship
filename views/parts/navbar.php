...
" alt="logo"/></a>
    ...
    <div class="navbar-menu-wrapper d-flex align-items-center">
        <ul class="navbar-nav navbar-nav-left header-links d-none d-md-flex">
            <li class="nav-item">
                <a class="nav-link balance"><?= Yii::t('app','Your Balance: ') ?> <?= $payout->getSuccessPayoutSummary(Yii::$app->user->id); ?> /  <?= $sumLead->getTotalLeadSummary(Yii::$app->user->id)  . '<span class="ml-1" data-toggle="tooltip" data-placement="top"  title="' . Yii::t('app','Payed / Summary') . '">' . "RUB" . '</span>'; ?>
                </a>
            </li>
        </ul>
