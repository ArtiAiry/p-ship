...
<div class="wrap">
            ...
            <div id="w0-collapse" class="collapse navbar-collapse">
                <ul id="w1"class="navbar-nav navbar-right nav">
                    ...
                    <?php else: ?>
                        ...
                        <li> <a href="<?= Url::toRoute(['/profile/view','id'=>Yii::$app->user->identity->id]);?>" title="View" aria-label="View"><span class="fa fa-eye"></span></a></li>
    ...
    <div class="container">
        <?php if(!Yii::$app->user->isGuest):?>
        <a href="<?= Url::toRoute(['/auth/logout'])?>">Logout(<?=Yii::$app->user->identity->username?>)</a>
        <?php endif; ?>
