...
$confirmLink = Yii::$app->urlManager->createAbsoluteUrl(['register/email-confirm', 'token' => $user->email_confirm_token]);
?>
<?php
...
<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; width: 100%;" class="background"><tr><td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;"
	...
	max-width: 500px;" class="wrapper">
			...
			padding-bottom: 20px;">
				...
				color: #2D3445;" class="preheader">
                        ...
                        <a target="_blank" style="text-decoration: none;"
                           href="http://bontip.ru/"><img border="0" vspace="0" hspace="0"
                                                         src="<?= $logo; ?>"
                                                         width="100" height="30"
			...
			padding-top: 0px;" class="hero"><a target="_blank" style="text-decoration: none;"
                                               href="http://bontip.ru/"><img border="0" vspace="0" hspace="0"
                                                                             src="<?= $confirm; ?>"
                                                                             alt="Partnership message" title="Partnership message"
                                                                             width="340" style="
			width: 87.5%;
			max-width: 340px;
			...
			font-family: sans-serif;" class="header">
                        Доброго времени суток, <?= Html::encode($user->username) ?>,
                    </td>
                </tr>
			...
			font-family: sans-serif;" class="paragraph">
                        Вы зарегистрировались на нашем сайте, и для того, чтобы начать работу, Вам нужно подтвердить аккаунт, нажав на кнопку подтверждения аккаунта ниже:
                    </td>
                </tr>
...
<?= $confirmLink ?>">
                ...
                <tr>
                    <td align="center" valign="top" style="border-collapse: collapse; text-decoration: none; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 14px; font-weight: 400; line-height: 150%; letter-spacing: 2px;
			padding-top: 27px;
			padding-bottom: 0;
			color: #FFFFFF;
			font-family: sans-serif;" class="supheader">
                        Если регистрировались на нашем сайте не Вы - просто проигнорируйте это сообщение.
                    </td>
                </tr>
